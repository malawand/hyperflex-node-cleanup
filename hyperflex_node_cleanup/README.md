# hyperflex-node-cleanup

*Cleans up an ESXi host and storage controller in order to redeploy an SCVM on it. This can also be run on all nodes in a cluster to reinstall an HX cluster*
...
- Mazen Lawand <malawand@cisco.com>
